...
<body>
      ...
      <nav class="navbar navbar-expand-sm navbar-dark bg-primary sticky-top ">
         ...
         <div class="collapse navbar-collapse justify-content-center" id="collapsibleNavbar">
            <ul class="navbar-nav ">
               ...
               <li class="nav-item ml-3">
                  <button class="btn btn-warning active" type="button" onclick="location.href='booking.php'">Booking</button>
               </li>
               <li class="nav-item ml-3">
   ...
   <div class="container margin-top-6">
      <div class="row">
         ...
         <div class="col-sm text-center mt-3 column1">
            <div>
<?php
               ...
               if (isset($_SESSION["loggedIn"]) && $_SESSION["loggedIn"] == 1) {
                  ...
                  echo "<p><h3> Book a service or repair: </h3></p>";
                  // show bookingForm.php overhere
                  include 'other php pages/bookingForm.php';
               } else {

                  // if not logged in, show registeration form 
                  echo "<p><h3> Registeration form: </h3></p>";

                  include 'other php pages/registerationForm.php';
               }
...
?>
   ...
   <script src="js/date_validator.js" type="text/JavaScript"></script>
