...
// Redirect to customer private page
...
<body>
      ...
      <nav class="navbar navbar-expand-sm navbar-dark bg-primary sticky-top ">
         ...
         <div class="collapse navbar-collapse justify-content-center" id="collapsibleNavbar">
            <ul class="navbar-nav ">
               ...
               <li class="nav-item ml-3">
                  <button class="btn btn-warning active" type="button" onclick="location.href='login.php'">Log in </button>
               </li>
            </ul>
         </div>
   ...
   <div class="container margin-top-6">
      <div class="row">
         ...
         <div class="col-md text-center mt-3 column1">
            <div>
<?php
// if not logged in, show login form
echo "<p><h3> Login form: </h3></p>";
include 'other php pages/loginForm.php';
?>
            </div>
         </div>
         <!--- End of First column of the row -->
      </div>
   </div>
   <!-- Optional JavaScript -->
