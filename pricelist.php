...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-primary sticky-top ">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="collapsibleNavbar">
        ...
        <ul class="navbar-nav ">
          ...
          <li class="nav-item ml-3">
            <button class="btn btn-warning active" type="button" onclick="location.href='pricelist.php'">Price list</button>
          </li>
          <li class="nav-item ml-3">
  ...
  <div class="container margin-top-6">
    <div class="row">
      ...
      <div class="col-sm offset-sm-1 text-center mt-3 column1">
        <div>
          <p>
            <h4><b>Major Service</b> 100€</h4> <br>
            includes:<br>
            ✔ oil change<br>
            ✔ oil filter<br>
            ✔ 10 point check<br>
      ...
      <div class="col-sm offset-sm-1 text-center mt-3 column1">
        ...
        <div>
          <p>
            <h4><b>Annual Service</b> 150€</h4> <br>
            includes:<br>
            ✔ oil change<br>
            ✔ oil filter<br>
            ✔ 10 point check<br>
      ...
      <div class="col-sm offset-sm-1 text-center mt-3 column1">
        ...
        <div>
          <p>
            <h4><b>Major Repair</b> 100-150€</h4> <br>
            includes:<br>
            ✔ parts replacing<br>
            ✔ check up<br>
            ✔ general cleaning
